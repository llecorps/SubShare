            ...
            <form role="form">
                <div class="tab-content">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                        <h3>Step 2</h3>
                        <p>Translate and save your work in EDIT Panel</p>
                        <ul class="list-inline pull-right">
                    ...
                    <div class="tab-pane" role="tabpanel" id="step3">
                        <h3>Step 3</h3>
                        <p>Make your own srt File in RESTORE panel -> Save on Desktop!</p>
                        <ul class="list-inline pull-right">
                            <li><button type="button" class="btn btn-default prev-step">Previous</button></li>
...
<div class="container">
    ...
    <form method="post" action="accueil" enctype="multipart/form-data">
        ...
        <p>
            <label for="fichier">File to Upload : </label>
